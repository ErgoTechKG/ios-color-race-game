...
enum CardStore {
    ...
    static let mediumCardBack = CardBack(font: GameUx.subtitleFont(), textColor: .black, innerCornerRadius: 5, innerBorderColor: .black, innerBorderWidth: 5)
    ...
    static let standardCardBack = CardBack(font: GameUx.titleFont(), textColor: .black, innerCornerRadius: 15, innerBorderColor: .black, innerBorderWidth: 2)
    static let standardCardBackView = CardBackView(cardLayout: standardCardLayout, cardBack: standardCardBack, degree: .constant(0))
    
    static let mediumCardFace = CardFace(letter: CardDetail.letters.randomElement()!, suit: CardDetail.suits.randomElement()!, fontSize: 10, colors: defaultBoardColors)
    ...
    static let standardCardFace = CardFace(letter: CardDetail.letters.randomElement()!, suit: CardDetail.suits.randomElement()!, fontSize: 20, colors: defaultBoardColors)
